...
syn keyword fishStatement def nextgroup=fishFunction skipwhite
syn keyword fishStatement2 end
syn match   fishFunction
      \ "\%(\%(def\s\)\s*\)\@<=\h\%(\w\|\.\)*" contained
syntax match fishVariable /[\$_]\+[[:alnum:]]*/ 
...
hi link fishStatement2 Statement	
...
hi link fishVariable Identifier
